...
export const NoteDataContextProvider = ({ children }) => {
    ...
    const [noteTitle, setNoteTitle] = useLocalStorage("title", "");
    const [noteAuthor, setNoteAuthor] = useLocalStorage("author", "");
    const [noteTexts, setNoteTexts] = useLocalStorage("texts", "");
